...
import adminDashRoutes from "./routes/adminDashRoutes.js";
import platformDashRoutes from "./routes/platformDashRoutes.js";
...
app.use("/api/admin/auth", staffAuthRoutes);
app.use("/api/admin/users", adminUserRoutes);
app.use("/api/admin", adminDashRoutes);  
app.use("/api/platform-manager", platformDashRoutes);
