...
export default function PlatformManagerSidebar() {
    ...
    <div className="flex h-screen w-64 flex-col bg-zinc-900 text-white">
      ...
      <div className="border-t border-zinc-800 p-4">
        <button
          ...
          className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-zinc-300 transition-colors hover:bg-zinc-800 hover:text-white"
        >
          <svg
            className="h-5 w-5"
            fill="none"
